...
public class Preprocessor {
	...
	public static void main(String[] args) {
		...
		String arg1 = args[0]; //INPUT_FILE -- downloaded_file_from_CTD_database (refer Documentation/Drug_gene_association.docx)
		String arg2 = args[1]; //OUTPUT_FILE_noIntroSection (refer Documentation/Drug_gene_association.docx)
