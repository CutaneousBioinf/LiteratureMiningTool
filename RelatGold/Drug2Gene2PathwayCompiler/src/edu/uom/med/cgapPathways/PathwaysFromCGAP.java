...
public class PathwaysFromCGAP {
	...
	public static void main(String[] args) {
		...
		String arg2 = args[1]; //OUTPUT_FILE -- gene with list of pathways
				...
				if(eachline.startsWith(">>")) {
					...
					if(eachdata.size()==1) {
						...
						for(String each : eachdata) {
							...
							else if(each.startsWith("BIOCARTA:") || each.startsWith("KEGG:")) {
					...
					if(eachline.startsWith("SYMBOL:") || eachline.startsWith("BIOCARTA:") || eachline.startsWith("KEGG:")) eachdata.add(eachline);
				}
			}
