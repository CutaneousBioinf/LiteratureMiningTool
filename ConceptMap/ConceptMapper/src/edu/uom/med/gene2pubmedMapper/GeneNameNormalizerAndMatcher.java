...
/**
 * Class implements normalization rules for gene mapping
 * 
 * @author Kalpana Raja
 *
 */

public class GeneNameNormalizerAndMatcher {
	 ...
	 * @param ukspelling
	 * @param genericAcronyms
	 * @return
	 */
	
	public String performNormalizedGeneMapping(String geneName1, String eachSentence1, ArrayList<String> stopWords,
			LinkedHashMap<String, String> UKAndUS_Spelling, ArrayList<String> ukspelling, ArrayList<String> genericAcronyms) {
		...
		if(eachSentence1.contains(" ")) { //check whether it is a proper sentence
			...
			String eachSentence3 = textNormalizer(geneName2, eachSentence2, genericAcronyms);
	...
	public String textNormalizer(String geneName2, String eachSentence2, ArrayList<String> genericAcronyms) {
