...
public class TestPharmGKB2UMLS {
	...
	public static void main(String[] args) {
		...
		String arg4 = args[3]; //OUTPUT_FILE -- PharmGKB2UMLS_mapped
		String arg5 = args[4]; //OUTPUT_FILE -- PharmGKB2UMLS_not_mapped
		...
		try {
		    ...
		    //FileInputStream fis = new FileInputStream("pharmgkbSynonyms.txt");
