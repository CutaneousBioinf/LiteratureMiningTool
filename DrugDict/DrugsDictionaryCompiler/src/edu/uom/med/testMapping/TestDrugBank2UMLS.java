...
/**
 * Program maps drug mentions from DrugBank to chemical/drug mentions in UMLS Metathesaurus. 
 * The output of the program is the drugs present in both the resources. This knowledge is
...
public class TestDrugBank2UMLS {
	...
	public static void main(String[] args) {
		...
		String arg1 = args[0]; //INPUT_FILE -- umlsDrugsSynonyms
		String arg2 = args[1]; //INPUT_FILE -- umlsDrugsSynonyms_normalized
		String arg3 = args[2]; //OUTPUT_FILE -- drugBankSynonyms
		String arg4 = args[3]; //OUTPUT_FILE -- DrugBank2UMLS
		String arg5 = args[4]; //OUTPUT_FILE -- DrugBank2UMLS_not_mapped
